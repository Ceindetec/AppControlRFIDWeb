...
<div class="panel panel-primary">
	...
	<script>
		...
		function generar() {
			...
			if (funcionario.val()){
				var data = {'fecha_desde': fechaDesde.val(), 'fecha_hasta': fechaHasta.val(), 'hora_desde': horaDesde.val(), 'hora_hasta': horaHasta.val(), 'modulo': seccion.val(), 'funcionario': funcionario.val()};
